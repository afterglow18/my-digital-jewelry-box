...
const ROSE      = "#C47A8A";   // dusty pink — Spin It button colour
const ROSE_DARK = "#A85E70";   // dusty pink mid
...
function RoseButton({
  ...
  return (
    <button
      ...
      style={{
        background: disabled ? '#A85E70' : 'linear-gradient(to bottom, #C47A8A, #A85E70)',
