...
const ROSE      = "#E2B0C2";   // dusty pink — Spin It button colour
const ROSE_DARK = "#C994A8";   // dusty pink mid
...
function RoseButton({
  ...
  return (
    <button
      ...
      style={{
        background: disabled ? '#C994A8' : 'linear-gradient(to bottom, #E2B0C2, #C994A8)',
